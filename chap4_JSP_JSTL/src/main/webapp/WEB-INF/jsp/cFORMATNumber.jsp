...
<body>
	...
	날짜를 특정형식으로 출력하거나, 숫자를 통화, 퍼센트 형식으로 변환할 수 있음
	숫자 포맷팅 태그
	fmt:formatNumber
	...
	number	 : 숫자를 소수점 자리까지 조정하면서 표현할 수 있음
		...
		만약에 2라고 작성하면 소수점 밑 숫자는 2자리까지 보여야함
		maxIntegerDigits  : 최소 지정한 자리수 이상 소수점에서 보여주기 
		만약에 2라고 작성하면 소수점밑에 숫자가 최소 2자리 이상 보여야함
