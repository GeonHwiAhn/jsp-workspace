...
<body>
	...
	EL(Expresssion Language)
		목적 : EL은 JSP 페이지에서 요청(request)이나 세션(session)과 같은 데이터를 
		쉽게 가져와서 출력하는데 주로 사용
		문법 : $ { } 사용해서 값을 출력
	...
	JSTL(Javaserver pages Standard Tag Library)
		...
		문법 : prefix="설정한변수명" 설정한변수명:기능작성
			prefix 안에 변수명을 설정할 때는 http://java.sun.com/jstl/core 위 주소에서 core로 끝날 때
	...
	그 페이지 내에서 사용할 수 있도록 설정
		문법 예제 : request.setAttribute(String name, 자료형 value)
			name : 데이터를 저장할 때 사용할 Key 나타냄 이 키를 이용해서 나중에 데이터 가져올 수 있음
			value : 저장할 실제 값(value) 문자열 숫자 배열 객체 등 어떤 데이터 유형동 저장할 수 있음
	</pre>
	...
	//username 변수명 안에 홍길동이라는 이름이 저장 저장된 이름을 다른데서 사용
	request.setAttribute("userage", age); 
	//useage 변수명 안에 20이라는 숫자를 저장하고 다른데서 숫자를 사용
	%>
	...
	//dispatcher : 전달자 상태를 전달한다는 의미 보내다
